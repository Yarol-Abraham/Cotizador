    ...
    <div class="container">
        <div class="row">
            ...
            ?>
                ...
                <div class="col-ms-12 col-md-8 col-lg-3 d-flex flex-column justify-content-between">
                    <div class="rounded py-3 mb-5 bg-<?php echo $value["bg"]; ?> bg-gradient d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="p-5 bg-white rounded d-flex flex-row justify-content-between align-items-center">
